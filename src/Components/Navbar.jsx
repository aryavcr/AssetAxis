...
function Navbar() {
  return (
    ...
    <div className="flex w-full justify-between items-center font-['Onest'] px-7 py-5 text-normal text-[#8c8cb1] font-medium" >
      <div className="h-10 w-10 "> <img src={img4}></img>  </div>
      ...
      <div className="w-fit h-fit px-4 py-1 my-1.5 text-center shadow-sm rounded-3xl bg-black text-white">Login</div>
    </div></div>
    </div>
  );
}
